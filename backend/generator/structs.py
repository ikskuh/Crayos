...
""")
    ...
    # nick_names_string = ', '.join(f'"{name}"' for name in old_nick_names_str_array)
    # nick_names_string = open(os.path.join(os.path.dirname(__file__), "../game/nick_names.txt")).read().splitlines()
